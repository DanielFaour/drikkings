  ...
  return (
    <div className="game" id="game2">
      ...
      <div id="game2Container" onPointerUp={shotsFired}>
        ...
        <div id="revGun" >
          <img ontouchstart="event.preventDefault();" draggable="false" className="rev_light" src={imageCache.current["revolver"]?.src} alt="revolver" />
          <img ontouchstart="event.preventDefault();" draggable="false" className="rev_dark" src={imageCache.current["revolver_dark"]?.src} alt="revolver" />
        </div>
        <p id="shotRounds">
          <br />
      ...
      {gameIntro && (
        <div id="game2Start" className={isIntroClicked ? "clicked" : ""}>
          ...
          >
            <img ontouchstart="event.preventDefault();" draggable="false" className="bullet" src={imageCache.current["bullet"]?.src} alt="revolver cylinder" />
            <img ontouchstart="event.preventDefault();" draggable="false" className="nobullet" src={imageCache.current["noBullet"]?.src} alt="revolver cylinder" />
          </div>
      ...
      {gameEnd && (
        <div id="game2End" onPointerUp={handlePointerUp}>
          ...
          <div id="game2Pang">
            <img ontouchstart="event.preventDefault();" draggable="false" className="light-img" src={imageCache.current["game2PangImg2"]?.src} alt="pang" />
            <img ontouchstart="event.preventDefault();" draggable="false" className="dark-img" src={imageCache.current["game2PangImg2_dark"]?.src} alt="pang" />
