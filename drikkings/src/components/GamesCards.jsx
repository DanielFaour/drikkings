...
function GamesCards() {
  ...
  return (
    <>
      ...
      <Button onClick={() => navigate('/games/game3')} label="🍼 Flasketuten peker på ⚠️" border="#FF9AF8" bg="#FF9AF8" text="black" />
      <Button onClick={() => navigate('/games/game4')} label="🎨 Color Picker 🎨" border="#9AA8FF" bg="#9AA8FF" text="black" />
      <Button onClick={() => navigate('/games/game5')} label="🍾 Shake it ⚠️" border="#9ADDFF" bg="#9ADDFF" text="black" />
